...
C_WORLD := game/world/world.c game/world/world_gen.c 
C_ENTITY := game/world/entity/player.c game/g_entity.c  game/world/entity/entity_brain.c
C_GAME := game/game.c game/log.c game/g_prompt.c game/g_cmd.c game/c_cmd.c $(C_WORLD) $(C_ENTITY) $(C_UI) $(C_HTTP) $(C_UTILS) $(C_THIRDPARTY)
